...
import { BookOpen, Calendar, MessageCircle, LogOut, Upload, Brain, Moon, Sun, Bot, History, Users, TrendingUp, Search as SearchIcon, FileText, Palette, ChevronsLeft, ChevronsRight, LayoutDashboard, Feather, Book, Clock, Heart, Trophy, Award } from "lucide-react";
...
const navItems = [
  ...
  { 
    ...
    icon: FileText,
    subItems: [
      { name: "Assignments Hub", href: createPageUrl("AssignmentsHub"), icon: FileText },
